...
@Module({
  imports: [
    ...
    TemporalModule.register({
      ...
      taskQueue: 'main-queue', // Shared queue
      worker: {
        workflowsPath: require.resolve('./temporal/workflows'), // can import multiple
        activityClasses: [EmailActivities, BlogActivities, ShopActivities], // Merge all activities
        autoStart: true,
      },
      isGlobal: true,
    }),
